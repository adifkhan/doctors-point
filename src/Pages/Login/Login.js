            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {errorMessage}
                        <small><Link className='text-secondary' to='/resetpass'>Forgot Password</Link></small>
                        <input className='btn w-full max-w-xs mt-2' type="submit" value="login" />
                    </form>
                    <p className='text-center'><small>New to DocPoint? <Link className='text-secondary font-bold' to='/signup'>Create new Account</Link></small></p>
